...
const HookItem* HookManager::FindHookItem(const char* szDllName, const char* szFunName)
{
	...
	catch (...)
	{
		...
		OutputDebugStringW(L"Exception on HookManager::FindHookItem\r\n");
	}
...
void HookManager::hook()
{
	...
	catch (...)
	{
		...
		OutputDebugStringW(L"Exception on HookManager::hook.\r\n");
	}
...
void HookManager::unhook()
{
	...
	catch (...)
	{
		...
		OutputDebugStringW(L"Exception on  HookManager::unhook.\r\n");
	}
