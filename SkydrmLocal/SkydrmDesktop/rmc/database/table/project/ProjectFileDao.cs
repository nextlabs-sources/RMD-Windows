...
namespace SkydrmLocal.rmc.database2.table.project
{
    public class ProjectFile
    {
        ...
        //
        // Extend the db table using the reserved fields.
        //
        public bool IsShared // reserved1
        {
            get
            {
                return reserved1 == "0" ? false : true;
            }

            set
            {
                reserved1 = (value == true ? "1" : "0");
            }
        }

        // Which projects the file is shared to.
        public List<uint> SharedWithProjects // reserved2
        {
            get
            {
                return Helper.ConvertString2List(reserved2);
            }

            set
            {
                reserved2 = Helper.ConvertList2String(value);
            }
        }


        public bool IsRevoked // reserved3
        {
            get
            {
                return reserved3 == "0" ? false : true;
            }

            set
            {
                reserved3 = (value == true ? "1" : "0");
            }
        }
        ...
        public static ProjectFile NewByReader(SQLiteDataReader reader)
        {
            var f = new ProjectFile
            {
                ...
                // Now use the reserved field: reserved1, reserved2, reserved3.
                reserved1 = reader["reserved1"].ToString(),
                reserved2 = reader["reserved2"].ToString(),
                reserved3 = reader["reserved3"].ToString(),
                Reserved4 = ""
            };
    ...
    public class ProjectFileDao
    {
                    ...
                    )
        {
            string sql = @"
                    ...
                    SET 
                        ...
                        reserved1 = @file_isShared,
                        reserved2 = @sharedWithProject,
                        reserved3 = @file_isRevoked
                    WHERE
            ...
            SQLiteParameter[] parameters = {
                ...
                new SQLiteParameter("@file_isShared",file_isShared.ToString()),
                new SQLiteParameter("@sharedWithProject",Helper.ConvertList2String(sharedWithProject)),
                new SQLiteParameter("@file_isRevoked",file_isRevoked.ToString()),
            };
            return new KeyValuePair<string, SQLiteParameter[]>(sql, parameters);
        }
            ...
            int project_table_pk, string path)
        {
            ...
            FROM
                ProjectFile
            WHERE
                 project_table_pk=@project_table_pk AND rms_path_id like @path
            ORDER BY 
                rms_path_id ASC;                    
            ";
            SQLiteParameter[] parameters = {
        ...
        public static KeyValuePair<String, SQLiteParameter[]> Update_FileWhenOverwrite_LeaveCopy_SQL(
            int table_pk, string duid,
            ...
            )
        {
            ...
            SQLiteParameter[] parameters = {
                ...
                new SQLiteParameter("@file_lastModifiedTime", modifiedTime)
            };
            return new KeyValuePair<string, SQLiteParameter[]>(sql, parameters);
        }

        // For sharing transaction
        public static KeyValuePair<String, SQLiteParameter[]> Update_IsShared_SQL(
            int table_pk,
            int isShared)
        {
            //  'reserved1' field is for IsShared.
            string sql = @"
                UPDATE 
                    ProjectFile
                SET
            ...
            SQLiteParameter[] parameters = {
                new SQLiteParameter("@table_pk",table_pk),
                new SQLiteParameter("@isShared",isShared.ToString())
            };
            return new KeyValuePair<string, SQLiteParameter[]>(sql, parameters);
        }

        public static KeyValuePair<String, SQLiteParameter[]> Update_IsRevoked_SQL(
            int table_pk,
            int isRevoked)
        {
            //  'reserved1' field is for IsShared.
            ...
            SQLiteParameter[] parameters = {
                new SQLiteParameter("@table_pk",table_pk),
                new SQLiteParameter("@isRevoked",isRevoked.ToString())
            };
            return new KeyValuePair<string, SQLiteParameter[]>(sql, parameters);
        }

        public static KeyValuePair<String, SQLiteParameter[]> Update_SharedWithProjects_SQL(
            int table_pk, List<uint> projectList)
        {
            string strList = Helper.ConvertList2String(projectList);

            //  'reserved2' field is for SharedWithProjects.
            string sql = @"
                UPDATE 
                    ProjectFile
                SET
                    reserved2=@projectList 
                WHERE
                    id=@table_pk;
            ";
            SQLiteParameter[] parameters = {
                new SQLiteParameter("@table_pk",table_pk),
                new SQLiteParameter("@projectList",strList)
            };
            return new KeyValuePair<string, SQLiteParameter[]>(sql, parameters);
        }
        // -- End for sharing transaction.
    ...
    public class Helper
    {
        public static string ConvertList2String(List<uint> list)
        {
            string ret = "";
        ...
        public static List<uint> ConvertString2List(string  str)
        {
