...
{
    public class NxlOperLogDao
    {
        public static readonly string SQL_Create_Table_NxlOperLog = @"
                CREATE TABLE IF NOT EXISTS NxlOperLog (
                   id                   integer NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE ,
                   myvault_file_id      integer,
                   project_file_id      integer,     
                   project_local_file_id integer,
                   user                 varchar(255), 
                   operation            varchar(255), 
                   operation_time       DateTime, 
                   result               varchar(255), 

                   foreign key(myvault_file_id) references MyVaultFile(id) on delete cascade, 
                   foreign key(project_file_id) references ProjectFile(id) on delete cascade,
                   foreign key(project_local_file_id) references ProjectLocalFile(id) on delete cascade);
        ";

        //private SQLiteDBHelper sQLiteDBHelper = null;

        //public NxlOperLogDao(SQLiteDBHelper sQLiteDBHelper)
        //{
        ...
        //public List<NxlOperLog> QueryByMyVaultFileId(Int32 parameter_MyVault_file_id)
        //{
        //    List<NxlOperLog> result = new List<NxlOperLog>();
        ...
        //        NxlOperLog operation = new NxlOperLog();
        //        operation.Id = Id;
        ...
        //public List<NxlOperLog> QueryByProjectFileId(Int32 parameter_project_file_id)
        //{
        //    List<NxlOperLog> result = new List<NxlOperLog>();
        ...
        //public List<NxlOperLog> QueryByProjectLocalFileId(Int32 parameter_project_local_file_id)
        //{
        //    List<NxlOperLog> result = new List<NxlOperLog>();
