...
namespace SkydrmLocal
{
    public partial class BaseWindow: Window
    {
        ...
        {
            SkydrmApp.Current.Resources.MergedDictionaries.Add(Application.LoadComponent(new Uri(string.Format("/Themes/BaseWindowStyle.xaml"), UriKind.Relative)) as ResourceDictionary);
            this.Style = (Style)SkydrmApp.Current.Resources["BaseWindowStyle"];
        }

        private void InitEvent()
        {
            ControlTemplate baseWinTemplate = (ControlTemplate)SkydrmApp.Current.Resources["BaseWindowControlTemplate"];
