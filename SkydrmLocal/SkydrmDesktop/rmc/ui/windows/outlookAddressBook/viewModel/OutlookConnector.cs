...
namespace SkydrmLocal.rmc.ui.windows.outlookAddressBook.viewModel
{
    public class OutlookConnector
    {
        ...
        public OutlookConnector()
        {
            ...
            if (officeType == null)
            {
                app.ShowBalloonTip(CultureStringInfo.ApplicationFindResource("Notify_PopBubble_Install_Outlook"), false);
                outlook = null;
                return;
            }
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(userName))
                {
                    outlook = null;
                    oNamespace = null;
                    app.ShowBalloonTip(CultureStringInfo.ApplicationFindResource("Notify_PopBubble_Login_Outlook"), false);
                }
            ...
            catch (System.Exception e)
            {
                ...
                outlook = null;
                oNamespace = null;
                app.ShowBalloonTip(CultureStringInfo.ApplicationFindResource("Notify_PopBubble_Open_Outlook"), false);
            }
