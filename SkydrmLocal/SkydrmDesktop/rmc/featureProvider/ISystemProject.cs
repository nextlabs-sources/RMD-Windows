...
namespace SkydrmLocal.rmc.featureProvider
{
    ...
    public interface ISystemProject : IHeartBeat
    {
        ...
        // Need to re-encrypt using system bucket token when export myVault\sharedWithMe files.
        string ProtectAdhocWhenExportMyVaultFile(string PlainFilePath, string DestFolder, List<FileRights> rights,
