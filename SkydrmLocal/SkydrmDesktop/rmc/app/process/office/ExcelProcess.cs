...
namespace SkydrmDesktop.rmc.app.process.office
{
    public class ExcelProcess : OfficeProcess
    {
        ...
        {
            Log.Info("\t\t ExcelProcess OpenFile \r\n" +
                     "\t\t\t\t filePath :" + filePath + "\r\n");
            ...
            {
                Log.Info("\t\t ExcelProcess OpenFile Error \r\n" +
                   "\t\t\t\t Message :" + ex.Message + "\r\n"+
                   "\t\t\t\t HResult :" + ex.HResult + "\r\n" +
        ...
        public override int GetPid()
        {
            ...
            {
                Log.Error("\t\t\t\t ExcelProcess GetPid Error \r\n");
                Log.Error(ex.Message.ToString(),ex);
            }
            Log.Info("\t\t\t\t\t\t ExcelProcess Pid :"+ processId+"\r\n");
            return processId;
        }
