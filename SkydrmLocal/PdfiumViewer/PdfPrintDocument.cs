    ...
    internal class PdfPrintDocument : PrintDocument
    {
        ...
        private void PrintSinglePage(PrintPageEventArgs e)
        {
            if (_currentPage < _document.PageCount)
            {
                ...
                if (OnPrintSinglePageListener != null)
                {
                    OnPrintSinglePageListener.OnPrintSinglePageListener(e, size.Width, size.Height);
                }
        ...
        public IOnPrintSinglePageListener OnPrintSinglePageListener { get; set; }
