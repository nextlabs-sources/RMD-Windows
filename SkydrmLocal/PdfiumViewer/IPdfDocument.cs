...
namespace PdfiumViewer
{
    ...
    public interface IPdfDocument : IDisposable
    {
        ...
        /// </summary>
        /// <returns></returns>
        PrintDocument CreatePrintDocument(IOnPrintSinglePageListener onPrintSinglePageListener);
        ...
        /// <returns></returns>
        PrintDocument CreatePrintDocument(PdfPrintMode printMode, IOnPrintSinglePageListener onPrintSinglePageListener);
        ...
        /// <returns></returns>
        PrintDocument CreatePrintDocument(PdfPrintSettings settings, IOnPrintSinglePageListener onPrintSinglePageListener);
