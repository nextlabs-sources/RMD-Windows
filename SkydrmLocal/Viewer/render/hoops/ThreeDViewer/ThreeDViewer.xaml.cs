...
using Viewer.hoops;
using Viewer.hoops.Commands;
using Viewer.overlay;
using Viewer.utils;
using Viewer.viewer;

namespace Viewer.render.hoops.ThreeDView
{
    /// <summary>
    /// Interaction logic for ThreeDViewer.xaml
    /// </summary>
    public partial class ThreeDViewer : Page, IPrintable,IOverlay
    {
        // view window
        ...
        /// </summary>
        const string configfile = "hps_config.xml";
        ...
        public ThreeDViewer(ViewerWindow window, string filePath, WatermarkInfo watermarkInfo, log4net.ILog log)
        {
            log.Info("\t\t ThreeDViewer \r\n");
            InitializeComponent();
...
string REALDWG_INSTALL_DIR = null;
        ...
        private void OnFileDrop(object sender, MyFileDropEventArgs e)
        {
            ...
            if (HandledByVisualize(e.Filename)
                ...
                MessageBox.Show("Unsupported file format", CultureStringInfo.View_DlgBox_Title);
#endif
        }
        ...
        public void Unhighlight()
        {
            ...
            GetSprocketsControl().Canvas.GetWindowKey().GetHighlightControl().Unhighlight(highlightOptions);
            ...
            HPS.Database.GetEventDispatcher().InjectEvent(new HPS.ComponentHighlightEvent(HPS.ComponentHighlightEvent.Action.Unhighlight, new HPS.ComponentPath(), highlightOptions));
        }
