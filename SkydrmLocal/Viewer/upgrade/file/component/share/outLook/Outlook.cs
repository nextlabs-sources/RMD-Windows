...
namespace Viewer.upgrade.file.component.share.outLook
{
    public class Outlook
    {
        private ViewerApp app = (ViewerApp)ViewerApp.Current;
        ...
        public Outlook(ShareWindow sw)
        {
            ...
            if (officeType == null)
            {
                MessageNotify.ShowBalloonTip(app.SdkSession, app.FindResource("Outlook_Install").ToString(), false);
                outlookApp = null;
                return;
            }
            ...
            try
            {
                ...
                if (oNamespace.Accounts.Count <= 0)
                {
                    ...
                    outlookApp = null;
                    oNamespace = null;
                    MessageNotify.ShowBalloonTip(app.SdkSession, app.FindResource("v").ToString(), false);
                }
            }
            catch (System.Exception e)
            {
                ...
                outlookApp = null;
                oNamespace = null;
                MessageNotify.ShowBalloonTip(app.SdkSession, app.FindResource("Outlook_Open").ToString(), false);
            }
        }
        ...
        public void SelectNameDialog()
        {
            ...
            try
            {
                ...
                selectNameDialog.Caption = app.FindResource("Outlook_Dialog_Caption").ToString();
                ...
                BringWindowTop("#32770", app.FindResource("Outlook_Dialog_Caption").ToString());
