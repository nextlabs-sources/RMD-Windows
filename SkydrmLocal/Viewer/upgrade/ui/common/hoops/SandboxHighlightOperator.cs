...
namespace Viewer.upgrade.ui.common.hoops
{
    class SandboxHighlightOperator : SelectOperator
    {
        private ThreeDViewer Window { get; set; }

        public SandboxHighlightOperator(ThreeDViewer window) : base(MouseButtons.ButtonLeft(), new ModifierKeys())
        {
            Window = window;
        }
