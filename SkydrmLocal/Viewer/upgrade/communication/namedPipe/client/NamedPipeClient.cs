...
namespace Viewer.upgrade.communication.namedPipe.client
{
        ...
        public static void Start(string jsonContent)
        {
            ...
            try
            {
              ...
              //  string receivedStr = string.Empty;
                ...
                System.IO.StreamReader stringReader = new System.IO.StreamReader(pipeClient);
                System.IO.StreamWriter streamWriter = new System.IO.StreamWriter(pipeClient);
