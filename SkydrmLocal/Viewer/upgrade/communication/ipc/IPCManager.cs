...
namespace Viewer.upgrade.communication.message
{
    ...
    {
        public const uint WM_CHECK_IF_ALLOW_LOGOUT = 50005;
        public const uint WM_START_LOGOUT_ACTION = 50006;
        ...
        public IntPtr WndProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            try
            {
                ...
                else if (msg == WM_CHECK_IF_ALLOW_LOGOUT)
                {
                    ...
                    MessageNotify.ShowBalloonTip(application.SdkSession, application.FindResource("Notify_PopBubble_Forbid_Logout").ToString() , false);
                    handled = true;
                    return new IntPtr(BROADCAST_QUERY_DENY);
                }
