...
namespace SDWRmcCSharpLib.core
{
    ...
    public class Boundary
    {
        ...
        [DllImport(Config.DLL_NAME,
            CallingConvention = CallingConvention.Cdecl,
            CharSet = CharSet.Unicode,
            EntryPoint = "SDWL_RPM_GetRights")]
        public static extern uint SDWL_RPM_GetRights(
            IntPtr hSession,
            string filePath,
            out IntPtr pArray,
            out int pSize,
        ...
        [DllImport(Config.DLL_NAME, CallingConvention = CallingConvention.Cdecl,
        CharSet = CharSet.Unicode, EntryPoint = "SDWL_RPM_GetRPMDir")]
        public static extern uint SDWL_RPM_GetRPMDir(IntPtr hSession, out IntPtr pArray,
        out int pSize, int option = 1);
        ...
        [DllImport(Config.DLL_NAME, CallingConvention = CallingConvention.Cdecl,
             CharSet = CharSet.Unicode, EntryPoint = "SDWL_RPM_EditSaveFile")]
        public static extern uint SDWL_RPM_EditSaveFile(
            IntPtr hSession,
            [MarshalAs(UnmanagedType.LPWStr)] string filePath,
       ...
       CharSet = CharSet.Unicode, EntryPoint = "SDWL_RPM_GetFileStatus")]
        ...
        [DllImport(Config.DLL_NAME, CallingConvention = CallingConvention.Cdecl,
        CharSet = CharSet.Unicode, EntryPoint = "SDWL_RPM_RegisterFileAssociation")]
        public static extern uint SDWL_RPM_RegisterFileAssociation(IntPtr hSession,
            [MarshalAs(UnmanagedType.LPWStr)] string fileextension,
