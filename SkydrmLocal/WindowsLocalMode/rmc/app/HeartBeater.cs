...
*/
    class HeartBeater
    {
        ...
        public HeartBeater(SkydrmLocalApp host)
        {
            this.host = host;
        }
        ...
        private void HeartBeat()
        {
            ...
            SkydrmLocalApp.Singleton.Log.Info("====HeartBeat started!====");
            try
            {
                ...
                while (!stop)
                {
                    ...
                    SkydrmLocalApp.Singleton.Log.Info(String.Format("====HearBeat {0}s====", count++));
            ...
            SkydrmLocalApp.Singleton.Log.Info("====HeartBeat finished!====");
        }
    }
}
