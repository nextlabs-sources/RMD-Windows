...
namespace SkydrmLocal.rmc.sdk
{
    public class User
    {
        ...
        public void GetRecipents2(string nxlFilePath, out string[] emails, out string[] addEmails, out string[] removeEmails)
        {
            ...
            emails = Helper.ParseRecipents(recipents).ToArray();
            addEmails = Helper.ParseRecipents(recipentsAdd).ToArray();
            removeEmails = Helper.ParseRecipents(recipentsRemove).ToArray();
        }
        ...
        public Dictionary<string, List<string>> GetNxlTagsWithoutToken(string nxlpath)
        {
            ...
            return Helper.ParseClassificationTag(tags);
        }
