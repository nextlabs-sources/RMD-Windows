    ...
    class SqliteOpenHelper
    {
            ...
            Action<SQLiteDataReader> action)
        {
            ...
            catch (Exception e)
            {
                ...
                SkydrmLocalApp.Singleton.Log.Error("SQLiteException in ExecuteReader", e);
            }
        }
        ...
        public static int ExecuteNonQuery(string connectionString, string sql, SQLiteParameter[] parameters)
        {
            ...
            catch (Exception e)
            {
                ...
                SkydrmLocalApp.Singleton.Log.Error("SQLiteException in ExecuteNonQuery: " + e.Message);
            }
        ...
        public static int ExecuteNonQueryBatch(string connectionString, KeyValuePair<string, SQLiteParameter[]>[] sqls)
        {
            ...
            catch (Exception e)
            {
                ...
                SkydrmLocalApp.Singleton.Log.Error("SQLiteException in ExecuteNonQueryBatch: " + e.Message);
            }
